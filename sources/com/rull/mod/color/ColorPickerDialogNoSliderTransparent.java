...
public class ColorPickerDialogNoSliderTransparent extends Dialog implements View.OnClickListener, ColorPickerView.OnColorChangedListener {
    ...
    public ColorPickerDialogNoSliderTransparent(Context context, int i, String str) {
        super(context);
    ...
    private void setUp(int i) {
        ...
        this.mHexVal.setOnEditorActionListener(new TextView.OnEditorActionListener(this) { // from class: com.rull.mod.color.ColorPickerDialogNoSliderTransparent.100000000
            private final ColorPickerDialogNoSliderTransparent this$0;

...
import com.rull.mod.color.ColorPickerDialog;
...
public class ColorPickerPreference extends Preference implements Preference.OnPreferenceClickListener, ColorPickerDialog.OnColorChangedListener {
    ...
    private static class SavedState extends Preference.BaseSavedState {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: com.rull.mod.color.ColorPickerPreference.SavedState.100000000
    ...
    @Override // com.rull.mod.color.ColorPickerDialog.OnColorChangedListener
    ...
    protected void showDialog(Bundle bundle) {
        this.mDialog = new ColorPickerDialog(getContext(), this.mValue, getTitle().toString());

...
final class C0806g extends AbstractC0809j {

    /* JADX INFO: renamed from: a */
    private /* synthetic */ C0801b f1888a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    C0806g(C0801b c0801b, C0498o c0498o) {
        super(c0801b, c0498o);
        this.f1888a = c0801b;
    }
    ...
    final /* synthetic */ Comparable mo1637a(C0498o c0498o, C0812m c0812m, int i) {
        return c0812m.m1665a(c0498o.m655g());
    }
    ...
    final void mo1638a(int i, C0812m c0812m, int i2, int i3) {
        if (i3 < 0 || i3 > 65535) {
            throw new C0503t("field ID not in [0, 0xffff]: " + i3);
        }
        c0812m.f1913d[i2] = (short) i3;
    }

    @Override // com.p046a.p049b.p065e.AbstractC0809j
    /* JADX INFO: renamed from: a */
    final /* synthetic */ void mo1639a(Comparable comparable) {
        ((C0506w) comparable).m691a(this.f1888a.f1866g);
    }
}

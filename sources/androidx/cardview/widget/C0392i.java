...
class C0392i extends Drawable {
    ...
    C0392i(ColorStateList colorStateList, float f) {
        this.mRadius = f;
    ...
    private void updateBounds(Rect rect) {
        ...
        if (this.mInsetForPadding) {
            this.mBoundsI.inset((int) Math.ceil(C0393j.calculateHorizontalPadding(this.mPadding, this.mRadius, this.mInsetForRadius)), (int) Math.ceil(C0393j.calculateVerticalPadding(this.mPadding, this.mRadius, this.mInsetForRadius)));

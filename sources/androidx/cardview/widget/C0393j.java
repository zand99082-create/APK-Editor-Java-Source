...
class C0393j extends Drawable {
    private static final double COS_45 = Math.cos(Math.toRadians(45.0d));
    private static final float SHADOW_MULTIPLIER = 1.5f;
    static InterfaceC0394k sRoundRectHelper;
    ...
    C0393j(Resources resources, ColorStateList colorStateList, float f, float f2, float f3) {
        this.mShadowStartColor = resources.getColor(C0397n.cardview_shadow_start_color);
        this.mShadowEndColor = resources.getColor(C0397n.cardview_shadow_end_color);
        this.mInsetShadow = resources.getDimensionPixelSize(C0398o.cardview_compat_inset_shadow);

...
public class TypefaceCompatApi26Impl extends TypefaceCompatApi21Impl {
    ...
    */
    public Typeface createFromFontInfo(Context context, @Nullable CancellationSignal cancellationSignal, @NonNull FontsContractCompat.FontInfo[] fontInfoArr, int i) throws Throwable {
        ...
        if (isFontFamilyPrivateAPIAvailable()) {
            Map mapPrepareFontData = FontsContractCompat.prepareFontData(context, fontInfoArr, cancellationSignal);
            Object objNewFamily = newFamily();
            boolean z = false;
            for (FontsContractCompat.FontInfo fontInfo : fontInfoArr) {
                ByteBuffer byteBuffer = (ByteBuffer) mapPrepareFontData.get(fontInfo.getUri());
                if (byteBuffer != null) {

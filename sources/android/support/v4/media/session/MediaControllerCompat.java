        ...
        switch (str) {
            ...
            case "android.support.v4.media.session.action.UNFOLLOW":
                if (bundle == null || !bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                    throw new IllegalArgumentException("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action " + str + Deobfuscator.CLASS_NAME_SEPARATOR);
                }
                return;
            default:
                return;

...
class FindAddress {
    ...
    private static final String f355NL = "\n\u000b\f\r\u0085\u2028\u2029";

    /* JADX INFO: renamed from: SP */
    private static final String f356SP = "\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000";
    private static final String WORD_DELIM = ",*•\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029";
    private static final String WORD_END = "(?=[,*•\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029]|$)";

    /* JADX INFO: renamed from: WS */
    private static final String f357WS = "\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029";
    ...
    */
    private static int attemptMatch(String str, MatchResult matchResult) {
        ...
        while (true) {
            ...
            int i5 = iEnd2;
            int i6 = i4;
            while (i5 < matcher.start()) {
                int i7 = i5 + 1;
                if (f355NL.indexOf(str.charAt(i5)) != -1) {
                    i6++;
                    i5 = i7;
                } else {
                    i5 = i7;
            ...
            if (matchHouseNumber(str, i5) == null) {
                z2 = false;
                if (!isValidLocationName(matcher.group(0))) {
                    ...
                    if (z && i3 > 4 && (matchResultMatchState = matchState(str, i5)) != null) {
                        if (str2.equals("et") && matchResultMatchState.group(0).equals("al")) {
                        ...
                        if (matcher2.find(matchResultMatchState.end())) {
                            ...
                            iEnd3 = matchResultMatchState.end();
                            i5 = i2;
                        }
                    }
                } else {

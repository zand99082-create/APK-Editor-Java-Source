        ...
        while (i12 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isDecor) {
                    ...
                    int i14 = layoutParams.gravity & C0327R.styleable.AppCompatTheme_ratingBarStyleSmall;
                    switch (i13) {
                        case 1:
        ...
        for (int i20 = 0; i20 < childCount; i20++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (itemInfoInfoForChild = infoForChild(childAt2)) != null) {
                    int i21 = ((int) (itemInfoInfoForChild.offset * i19)) + paddingLeft;
                    if (layoutParams2.needsMeasure) {
                        layoutParams2.needsMeasure = false;
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (layoutParams2.widthFactor * i19), 1073741824), View.MeasureSpec.makeMeasureSpec((i10 - paddingTop) - paddingBottom, 1073741824));
                    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            if (childAt.getVisibility() != 8 && (layoutParams2 = (LayoutParams) childAt.getLayoutParams()) != null && layoutParams2.isDecor) {
                ...
                int i7 = layoutParams2.gravity & C0327R.styleable.AppCompatTheme_ratingBarStyleSmall;
                ...
                if (layoutParams2.height != -2) {
                    i9 = 1073741824;
                    int i10 = layoutParams2.height != -1 ? layoutParams2.height : measuredHeight;

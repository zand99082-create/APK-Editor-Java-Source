...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    final class C0157Op {
        ...
        C0157Op(int i, Fragment fragment) {
            this.cmd = i;
    ...
    private void doAddOp(int i, Fragment fragment, @Nullable String str, int i2) {
        ...
        addOp(new C0157Op(i2, fragment));
    }

    private static boolean isFragmentPostponed(C0157Op c0157Op) {
    ...
    final void addOp(C0157Op c0157Op) {
        this.mOps.add(c0157Op);
        c0157Op.enterAnim = this.mEnterAnim;
        c0157Op.exitAnim = this.mExitAnim;
        c0157Op.popEnterAnim = this.mPopEnterAnim;
        c0157Op.popExitAnim = this.mPopExitAnim;
    }
    ...
    final void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                C0157Op c0157Op = (C0157Op) this.mOps.get(i2);
                if (c0157Op.fragment != null) {
                    c0157Op.fragment.mBackStackNesting += i;
                    if (FragmentManagerImpl.DEBUG) {
                        Log.v(TAG, "Bump nesting of " + c0157Op.fragment + " to " + c0157Op.fragment.mBackStackNesting);
                    }
                }
            }
        }
    ...
    public final void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            C0157Op c0157Op = (C0157Op) this.mOps.get(i);
            switch (c0157Op.cmd) {
                case 0:
                    str2 = "NULL";
                    break;
            ...
            printWriter.print(" ");
            printWriter.println(c0157Op.fragment);
            if (z) {
                if (c0157Op.enterAnim != 0 || c0157Op.exitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("enterAnim=#");
                    printWriter.print(Integer.toHexString(c0157Op.enterAnim));
                    printWriter.print(" exitAnim=#");
                    printWriter.println(Integer.toHexString(c0157Op.exitAnim));
                }
                if (c0157Op.popEnterAnim != 0 || c0157Op.popExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("popEnterAnim=#");
                    printWriter.print(Integer.toHexString(c0157Op.popEnterAnim));
                    printWriter.print(" popExitAnim=#");
                    printWriter.println(Integer.toHexString(c0157Op.popExitAnim));
                }
            }
        }
    }
    ...
    final void executeOps() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (c0157Op.cmd) {
                case 1:
                    fragment.setNextAnim(c0157Op.enterAnim);
                    this.mManager.addFragment(fragment, false);
                    break;
                case 2:
                default:
                    throw new IllegalArgumentException("Unknown cmd: " + c0157Op.cmd);
                case 3:
                    fragment.setNextAnim(c0157Op.exitAnim);
            ...
            if (!this.mReorderingAllowed && c0157Op.cmd != 1 && fragment != null) {
    ...
    final void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            C0157Op c0157Op = (C0157Op) this.mOps.get(size);
            Fragment fragment = c0157Op.fragment;
            if (fragment != null) {
            ...
            switch (c0157Op.cmd) {
                case 1:
                    fragment.setNextAnim(c0157Op.popExitAnim);
                    this.mManager.removeFragment(fragment);
                    break;
                case 2:
                default:
                    throw new IllegalArgumentException("Unknown cmd: " + c0157Op.cmd);
                case 3:
                    fragment.setNextAnim(c0157Op.popEnterAnim);
                    this.mManager.addFragment(fragment, false);
                    break;
                case 4:
                    fragment.setNextAnim(c0157Op.popEnterAnim);
            ...
            if (!this.mReorderingAllowed && c0157Op.cmd != 3 && fragment != null) {
                this.mManager.moveFragmentToExpectedState(fragment);
            }
        }
    ...
    final Fragment expandOps(ArrayList arrayList, Fragment fragment) {
        ...
        while (true) {
            ...
            switch (c0157Op.cmd) {
                case 1:
                case 7:
                    arrayList.add(c0157Op.fragment);
                    break;
                case 2:
                    Fragment fragment2 = c0157Op.fragment;
                    ...
                    while (size >= 0) {
                        ...
                        if (fragment4.mContainerId != i3) {
                            ...
                            if (fragment4 == fragment3) {
                                this.mOps.add(i4, new C0157Op(9, fragment4));
                                i4++;
                                fragment3 = null;
                            }
                            C0157Op c0157Op2 = new C0157Op(3, fragment4);
                            c0157Op2.enterAnim = c0157Op.enterAnim;
                            c0157Op2.popEnterAnim = c0157Op.popEnterAnim;
                            c0157Op2.exitAnim = c0157Op.exitAnim;
                            c0157Op2.popExitAnim = c0157Op.popExitAnim;
                            this.mOps.add(i4, c0157Op2);
                ...
                case 3:
                case 6:
                    arrayList.remove(c0157Op.fragment);
                    if (c0157Op.fragment == fragment) {
                        this.mOps.add(i2, new C0157Op(9, c0157Op.fragment));
                        i2++;
                        fragment = null;
                    }
                    break;
                case 8:
                    this.mOps.add(i2, new C0157Op(9, fragment));
                    i2++;
                    fragment = c0157Op.fragment;
                    break;
            }
            i = i2 + 1;
        }
    ...
    final boolean interactsWith(int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            C0157Op c0157Op = (C0157Op) this.mOps.get(i2);
            int i3 = c0157Op.fragment != null ? c0157Op.fragment.mContainerId : 0;
            if (i3 != 0 && i3 == i) {
                return true;
            }
        }
    ...
    final boolean interactsWith(ArrayList arrayList, int i, int i2) {
        ...
        int i5 = 0;
        while (i5 < size) {
            C0157Op c0157Op = (C0157Op) this.mOps.get(i5);
            int i6 = c0157Op.fragment != null ? c0157Op.fragment.mContainerId : 0;
            if (i6 == 0 || i6 == i4) {
                i3 = i4;
            } else {
                for (int i7 = i; i7 < i2; i7++) {
                    ...
                    for (int i8 = 0; i8 < size2; i8++) {
                        C0157Op c0157Op2 = (C0157Op) backStackRecord.mOps.get(i8);
                        if ((c0157Op2.fragment != null ? c0157Op2.fragment.mContainerId : 0) == i6) {
                            return true;
                        }
                    }
                }
    ...
    final boolean isPostponed() {
        for (int i = 0; i < this.mOps.size(); i++) {
            if (isFragmentPostponed((C0157Op) this.mOps.get(i))) {
                return true;
            }
        }
        return false;
    ...
    final void setOnStartPostponedListener(Fragment.OnStartEnterTransitionListener onStartEnterTransitionListener) {
        ...
        while (true) {
            ...
            C0157Op c0157Op = (C0157Op) this.mOps.get(i2);
            if (isFragmentPostponed(c0157Op)) {
                c0157Op.fragment.setOnStartEnterTransitionListener(onStartEnterTransitionListener);
            }
            i = i2 + 1;
        }
    }

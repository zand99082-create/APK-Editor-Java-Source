...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
    ...
    private void moveSpinner(float f) {
        ...
        float fMax2 = ((float) (((double) (Math.max(0.0f, Math.min(fAbs, f2 * DECELERATE_INTERPOLATION_FACTOR) / f2) / 4.0f)) - Math.pow(r3 / 4.0f, 2.0d))) * DECELERATE_INTERPOLATION_FACTOR;
        int i = ((int) ((f2 * fMin) + (f2 * fMax2 * DECELERATE_INTERPOLATION_FACTOR))) + this.mOriginalOffsetTop;
        ...
        this.mProgress.setProgressRotation(((-0.25f) + (fMax * 0.4f) + (fMax2 * DECELERATE_INTERPOLATION_FACTOR)) * DRAG_RATE);
